...
def generate_launch_description():
    ...
    file_logging = ExecuteProcess(
        # cmd=['ros2', 'bag', 'record', '--include-hidden-topics', '-o', f'/home/trailbot/autoronto_bags/{current_date}-{formatted_time}','-a'],
        cmd=['ros2', 'bag', 'record', '-o', f'/home/trailbot/autoronto_bags/{current_date}-{formatted_time}','-a'],
        output='screen'
    )
