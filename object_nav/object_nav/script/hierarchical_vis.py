...
def main(cfg : DictConfig):
    Instance_trans = np.array([0, 0, 10])
    ...
    spheres_xy = spheres_centers[:, [0, 1]]
    # 扩展维数以便后续计算
    ...
    if os.path.isfile("/home/mfyuan/local_folder/OpenGraph/param.json"):
        loaded_view_params = o3d.io.read_pinhole_camera_parameters("/home/mfyuan/local_folder/OpenGraph/param.json")
        print(loaded_view_params)
        cvt = view_control.convert_from_pinhole_camera_parameters(loaded_view_params)
        print("cvt", cvt)
    ...
    print(pair_indices_set.shape[0])
    # 采样200对关系，具体多少物体不得而知
    num_sampled_pairs = min(50, pair_indices_set.shape[0])  
    ...
    for i in sampled_indices:
        ...
        bbox_xy = np.array([[bbox_center[0], bbox_center[1]]])
    ...
    def save_view_params(vis):
        ...
        o3d.io.write_pinhole_camera_parameters("/home/mfyuan/local_folder/OpenGraph/param.json", loaded_view_params)
    ...
    main.show_inst_sphere_lines = True
