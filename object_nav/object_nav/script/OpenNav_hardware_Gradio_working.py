        ...
        if not observation_buffer.empty():
            ...
            if configs.vis_all: #observation_buffer.empty() and     and used_idx % 2 == 0 and used_idx>2
                if VLT:
                    ...
                    messages = models.get_chatgpt_output("gpt-4.1", new_prompt, messages, "system", command, image_path1)
                    ...
                    while not api.completed_task:
                        ...
                        if not api.completed_task:
                            if api.failed_task:
                                ...
                                messages = models.get_chatgpt_output("gpt-4.1", new_prompt, messages, "user", command, image_path1)
                                if "content" in messages[-1]:
                                    with open(COT_LOG_PATH, "a") as f:
...
if __name__ == '__main__':
    ...
    command2 = "ros2 bag play /home/trailbot/bags/two_conesX" #2Indoor9 Outdoor #two_cones Indoor_3d
