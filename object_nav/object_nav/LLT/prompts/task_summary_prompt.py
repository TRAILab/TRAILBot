...
1. Summarise the trajectory generated for the robot, specifying key waypoint poses (positions, orientations) along the trajectory, and describing their relevance with respect to the given task.
