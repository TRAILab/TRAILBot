...
class API:
    ...
    def __init__(self, cfg, objects, idx, logger):#args, main_connection, logger, langsam_model, xmem_model, device
    ...
    def visualize_trajectory(self, point_clouds, trajectory):
        """
        Visualize a trajectory using Open3D's draw_geometries.
        
        Args:
            point_clouds (Pointcloud): A list of PointCloud objects.
            trajectory (list): A list of [x, y, z, theta] points.
        """
        if trajectory is None:
            print('Trajectory is None. Please generate a trajectory first.')
        ...
        point_clouds.extend([point_cloud])
        # Visualize the trajectory
        o3d.visualization.draw_geometries(point_clouds)
        print('Trajectory visualized!')

    def matrix_to_xyz_yaw(self, T):
        """
        ...
        print('Current position of Husky robot:', np.round([x, y, z, yaw], 3))
        return np.round([x, y, z, yaw], 3)
