...
class RagAgent(Agent):
    ...
    def llm_selector(self, llm_type, temperature, num_ctx):
        ...
        print(f"You are using LLM as your agent: {llm_type} with temperature {temperature} and num_ctx {num_ctx}")
    ...
    def query(self, question: str):
        ...
        response = ''.join(response.content.splitlines())
        print('inside the query',response)
...
if __name__ == "__main__":
    ...
    llm_name = 'gpt-4o' 
    agent = RagAgent(llm_type=llm_name)
