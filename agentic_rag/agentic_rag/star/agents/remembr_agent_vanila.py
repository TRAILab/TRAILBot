...
from agentic_rag.star.agents.agent_vanila import Agent, AgentOutput
...
class ReMEmbRAgent_VANILA(Agent):
    ...
    def set_memory(self, memory: Memory, scene_graph=None, dataset_start_timestamp=None, sbert_model=None, test_num=None, args=None, timestamp_list=None):
        ...
        #     from remembr.memory.hybrid_reranker import HybridReranker
...
if __name__ == "__main__":
    ...
    llm_name = 'gpt-4o'
    agent = ReMEmbRAgent_VANILA(llm_type=llm_name)
