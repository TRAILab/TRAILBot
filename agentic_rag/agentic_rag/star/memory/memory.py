...
class Memory:
    ...
    def search_scenegraph(self, query: str) -> dict:
        """
        Search and return the most relevant object from the scene graph memory.
        Should return a dictionary containing object_id, caption, position, hierarchy etc.
        """
        raise NotImplementedError
